      ...
      body: GestureDetector(
        ...
        child: Stack(
          ...
          children: [
            ...
            Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: ScreenUtil.sh(40) + MediaQuery.paddingOf(context).top),
            ...
            Positioned(
              bottom: MediaQuery.paddingOf(context).bottom + kFloatingActionButtonMargin + ScreenUtil.sh(10),
              left: 0,
              right: 0,
              child: Padding(
