...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void initState() {
    ...
    // Sync initial state dari provider ke controllers (after first frame)
    // Pastikan sinkronisasi hanya dilakukan sekali
    // WidgetsBinding.instance.addPostFrameCallback((_) {
    //   if (!mounted) return;
      
    //   // Hanya sync jika controller masih kosong (menghindari override user input)
