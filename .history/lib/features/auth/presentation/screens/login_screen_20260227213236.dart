...
import 'package:pos/features/auth/presentation/providers/login_ui_provider.dart';
...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final errorMessage = authAsync.hasError ? authAsync.error.toString() : null;
    ...
    return Scaffold(
      body: GestureDetector(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            Image.asset(isDark ? 'assets/images/backgrounds/bg-dark.webp' : 'assets/images/backgrounds/bg-light.webp', fit: BoxFit.cover),
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: isDark ? [Colors.black.withValues(alpha: 0.7), Colors.black.withValues(alpha: 0.4)] : [Colors.white.withValues(alpha: 0.7), Colors.white.withValues(alpha: 0.4)],
                ),
              ),
            ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Image.asset('assets/images/logos/pgi-horizontal.webp', width: 120),
                    ...
                    AnimatedSwitcher(
                      ...
                      child: errorMessage == null ? const SizedBox.shrink() : AnimatedAlert(
