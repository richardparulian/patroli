...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void _login() async {
    bool isFormValid = widget._formKey.currentState?.validate() ?? false;
  ...
  void _unfocus() {
    if (widget._usernameFocusNode.hasFocus) {
      widget._usernameFocusNode.unfocus();
    }

    if (widget._passwordFocusNode.hasFocus) {
  ...
  @override
  void dispose() {
    widget._usernameFocusNode.dispose();
    widget._passwordFocusNode.dispose();
