        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AnimatedSwitcher(
                      ...
                      child: ref.watch(authProvider.select((s) => s.errorMessage)) == null ? const SizedBox.shrink() : AnimatedErrorNotification(
                        color: Theme.of(context).colorScheme.error,
                        message: ref.watch(authProvider.select((s) => s.errorMessage)) ?? '',
                        key: ValueKey(ref.watch(authProvider.select((s) => s.errorMessage))),
                      ),
                    ),
                    AppTextField(
                      cursor: true,
          ...
          Positioned(
            ...
            child: Padding(
              ...
              child: AppButton(
                label: !ref.watch(authProvider.select((s) => s.isLoading)) ? 'Masuk' : null,
                indicator: ref.watch(authProvider.select((s) => s.isLoading)) ? const SizedBox(
                  height: 16,
                  width: 16,
                ...
                onPressed: ref.watch(authProvider.select((s) => s.isLoading)) ? null : _login,
              ),
            ),
          ),
        ],
