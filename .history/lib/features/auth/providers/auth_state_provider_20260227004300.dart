...
class AuthStates {
  ...
  AuthStates copyWith({bool? isAuthenticated, bool? isLoading, UserEntity? user, String? errorMessage}) {
    return AuthStates(
...
// :: Auth provider
final authProvider = NotifierProvider<AuthNotifier, AuthStates>(AuthNotifier.new);
