                            ...
                            GestureDetector(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundColor: isTorchOn 
                                  ? colorScheme.primary           // ✅ Saat flash on: primary color
                                  : Colors.grey.shade800,        // ✅ Saat flash off: grey
                                child: Icon(
                                  isTorchOn 
                                    ? Iconsax.flash_slash       // ✅ Saat flash on: icon slash
                                    : Iconsax.flash_1,           // ✅ Saat flash off: icon flash
                                  color: isTorchOn 
                                    ? colorScheme.onPrimary   // ✅ Saat flash on: onPrimary color
                                    : Colors.grey.shade400,    // ✅ Saat flash off: grey
                                ),
                              ),
                            ),
                          ],
