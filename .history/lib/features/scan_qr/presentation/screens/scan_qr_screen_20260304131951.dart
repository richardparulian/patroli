...
class _ScanQrScreenState extends ConsumerState<ScanQrScreen> with WidgetsBindingObserver {
  ...
  Future<void> _pickImageFromGallery() async {
    // STEP 1: Cek storage permission (untuk Android)
    final hasPermission = await PermissionService.checkAndRequestStoragePermission(
      context: context,
      deniedMessage: 'Izinkan akses ke galeri untuk memilih foto',
      permanentlyDeniedMessage: 'Izinkan akses ke galeri untuk memilih foto',
    );
  ...
  Widget build(BuildContext context) {
    ...
    final isTorchOn = scanQrState.isTorchOn;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: FilledButton(
                          onPressed: () => _controller.openGallery(),
