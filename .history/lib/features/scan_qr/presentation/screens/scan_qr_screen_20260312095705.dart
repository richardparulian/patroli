...
class _ScanQrScreenState extends ConsumerState<ScanQrScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await camera.checkCameraPermission(isCheckPermission: false);
    });
  }
  ...
  Future<void> _pickImageFromGallery() async {
    ...
    if (result != null && result.barcodes.isNotEmpty) {
      ...
      notifier.setErrorMessage(message: 'Kode QR tidak ditemukan pada gambar!');
    }
  }
      ...
      next.when(
        ...
        error: (msg) {
          ...
          AppDialog.showError(
            ...
            onButtonPressed: () async {
              // ref.read(scanQrProvider.notifier).clear();
              await ref.read(scanCameraProvider.notifier).rebuildScanner();
            },
          );
        },
      );
    ...
    return AiBarcodeScanner(
      ...
      onDetect: (value) {
        ...
        if (value.barcodes.isNotEmpty) {
          ...
          ref.read(scanCameraProvider.notifier).onScanned(qrCode);
        }
      },
      validator: (value) {
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: AppIconButton(
                  onPressed: isLoading ? null : () => ref.read(scanCameraProvider.notifier).pickImageFromGallery(),
