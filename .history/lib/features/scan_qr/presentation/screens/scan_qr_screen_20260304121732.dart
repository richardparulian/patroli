            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Card(
                    child: ListTile(
                      leading: Icon(Iconsax.camera, color: colorScheme.primary),
                      title: Text('Harap diperhatikan jika ada kendala dalam pembacaan QR Code, silakan refresh halaman ini.'),
                      trailing: Icon(Iconsax.arrow_right, color: colorScheme.primary),
                    ),
                  ),
                  Row(
                    children: [
