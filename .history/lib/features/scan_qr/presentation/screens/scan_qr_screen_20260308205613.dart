        ...
        children: [
          GestureDetector(
            ...
            child: CircleAvatar(
              ...
              child: Icon(Iconsax.arrow_left, color: colorScheme.onSurface.withValues(alpha: 0.6)),
            ),
          ),
          Expanded(
            child: Row(
              ...
              children: [
                GestureDetector(
                  ...
                  child: CircleAvatar(
                    radius: 20,
                    backgroundColor: colorScheme.surface,
                    child: Icon(isTorchOn ? Iconsax.flash_slash : Iconsax.flash_1, color: colorScheme.onSurface.withValues(alpha: 0.6)),
                  ),
                ),
              ],
            ),
