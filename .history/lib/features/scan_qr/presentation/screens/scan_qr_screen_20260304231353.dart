...
class _ScanQrScreenState extends ConsumerState<ScanQrScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: state.errorMessage == null ? _buildScanner(theme, colorScheme, state) : _buildError(colorScheme, state),
          ),
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: _buildBottomMenu(theme, colorScheme, state),
          ),
        ],
      ),
    );
  ...
  Widget _buildBottomMenu(ThemeData theme, ColorScheme colorScheme, ScanQrState state) {
    return Container(
