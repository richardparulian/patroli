...
class _VisitScreenState extends ConsumerState<VisitScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final scanQrDataRaw = args?['scanQr'];
      final scanQrData = scanQrDataRaw is ScanQrEntity ? scanQrDataRaw : ScanQrEntity.empty();
  ...
  Widget build(BuildContext context) {
    ...
    final args = GoRouterState.of(context).extra as Map<String, dynamic>;
    final scanQrData = args['scanQr'] as ScanQrEntity;
  ...
  Widget _buildFormSection({required bool isLoadingCheckOut}) {
    final args = GoRouterState.of(context).extra as Map<String, dynamic>;
    final checkInData = args['checkIn'] as CheckInEntity;
