...
class _VisitScreenState extends ConsumerState<VisitScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final report = GoRouterState.of(context).extra as ReportsEntity?;
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  AppIconButton(
                    onPressed: () async {
                      debugPrint('form: $report');

                      await notifier.runVisitCreate(
                        request: VisitRequest(
                          lightsStatus: form.lampuBanner ?? '',
                          bannerStatus: form.bannerUtama ?? '',
                          rollingDoorStatus: form.rollingDoor ?? '',
                          conditionRight: form.rollingDoorChecklist.contains('Saya sudah menyinari rolling door menggunakan senter') ? 'Bagus' : 'Rusak',
                          conditionLeft: form.rollingDoorChecklist.contains('Saya sudah melakukan tahap gedor rolling door') ? 'Bagus' : 'Rusak',
                          conditionBack: form.rollingDoorChecklist.contains('Saya sudah melakukan tahap gedor rolling door') ? 'Bagus' : 'Rusak',
                          conditionAround: form.rollingDoorChecklist.contains('Saya sudah melakukan tahap gedor rolling door') ? 'Bagus' : 'Rusak',
                        ),
