...
class _VisitScreenState extends ConsumerState<VisitScreen> with SingleTickerProviderStateMixin {
  ...
  late TextEditingController lightsStatusController;
  late TextEditingController bannerStatusController;
  late TextEditingController rollingDoorStatusController;
  late TextEditingController conditionRightController;
  late TextEditingController conditionLeftController;
  late TextEditingController conditionBackController;
  late TextEditingController conditionAroundController;
  late TextEditingController notesController;

  late FocusNode lightsStatusFocusNode;
  late FocusNode bannerStatusFocusNode;
  late FocusNode rollingDoorStatusFocusNode;
  late FocusNode conditionRightFocusNode;
  late FocusNode conditionLeftFocusNode;
  late FocusNode conditionBackFocusNode;
  late FocusNode conditionAroundFocusNode;
  ...
  void initState() {
    ...
    lightsStatusController = TextEditingController();
    bannerStatusController = TextEditingController();
    rollingDoorStatusController = TextEditingController();
    conditionRightController = TextEditingController();
    conditionLeftController = TextEditingController();
    conditionBackController = TextEditingController();
    conditionAroundController = TextEditingController();
    notesController = TextEditingController();

    lightsStatusFocusNode = FocusNode();
    bannerStatusFocusNode = FocusNode();
    rollingDoorStatusFocusNode = FocusNode();
    conditionRightFocusNode = FocusNode();
    conditionLeftFocusNode = FocusNode();
    conditionBackFocusNode = FocusNode();
    conditionAroundFocusNode = FocusNode();
    notesFocusNode = FocusNode();
  }

  @override
  void dispose() {
    lightsStatusController.dispose();
    bannerStatusController.dispose();
    rollingDoorStatusController.dispose();
    conditionRightController.dispose();
    conditionLeftController.dispose();
    conditionBackController.dispose();
    conditionAroundController.dispose();
    notesController.dispose();

    lightsStatusFocusNode.dispose();
    bannerStatusFocusNode.dispose();
    rollingDoorStatusFocusNode.dispose();
    conditionRightFocusNode.dispose();
    conditionLeftFocusNode.dispose();
    conditionBackFocusNode.dispose();
    conditionAroundFocusNode.dispose();
