...
class _VisitScreenState extends ConsumerState<VisitScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final dataRaw = args?['scanQr'];
      final scanQrData = dataRaw is ScanQrEntity ? dataRaw : ScanQrEntity.empty();
  ...
  Widget _buildFormSection({required bool isLoadingCheckOut}) {
    ...
    final dataRaw = args?['checkIn'];
    final checkInData = dataRaw is CheckInEntity ? dataRaw : CheckInEntity.empty();
