...
class _VisitScreenState extends ConsumerState<VisitScreen> {
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            _buildFormSection(isLoadingCheckOut: isLoadingCheckOut),
            ...
            if (!isLoadingAttention) ...[
              AppLoading(message: 'Memproses data...'),
            ],
  ...
  Widget _buildFormSection({required bool isLoadingCheckOut}) {
    ...
    final visitAttention = ref.watch(visitAttentionProvider).successData;
        ...
        children: [
          if (scanQrData.visitAttention?.requireAttentions == 1) ...[
            ...
            _buildInfoCard(
              ...
              value: visitAttention?.visitAttention?.notes ?? '-',
            ),
            const SizedBox(height: 10),
          ],
