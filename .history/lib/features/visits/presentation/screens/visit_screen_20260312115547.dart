...
class _VisitScreenState extends ConsumerState<VisitScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final dataRaw = args?['scanQr'] as ScanQrEntity?;
      final scanQrData = dataRaw ?? ScanQrEntity.empty();
       ...
       next.when(
        ...
        success: (value) {
          ...
          AppDialog.showSuccess(
            ...
            onButtonPressed: () {
              context.push(AppConstants.checkOutRoute, extra: args);
            },
          );
        },
        error: (msg) => null,
  ...
  Widget _buildFormSection({required bool isLoadingCheckOut}) {
    ...
    final dataRaw = args?['checkIn'] as CheckInEntity?;
    final checkInData = dataRaw ?? CheckInEntity.empty();
