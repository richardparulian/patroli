  ...
  Future<void> runVisitAttention(String qrCode) async {
    ...
    try {
      ...
      result.fold(
        ...
        (response) => state = Success(response),
      );
    } catch (e) {
...
final visitAttentionProvider = NotifierProvider.autoDispose<VisitAttentionNotifier, ResultState<ScanQrEntity>>(VisitAttentionNotifier.new);