...
class _VisitEntity implements VisitEntity {
  const _VisitEntity({this.id, this.date, this.checkIn, this.checkOut, this.checkInPhoto, this.checkOutPhoto, this.lightsStatus, this.bannerStatus, this.rollingDoorStatus, this.conditionRight, this.conditionLeft, this.conditionBack, this.conditionAround, this.notes, this.statusValue, this.statusDescription});
