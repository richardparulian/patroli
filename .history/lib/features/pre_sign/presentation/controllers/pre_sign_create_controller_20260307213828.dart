...
class PreSignCreateController extends AsyncNotifier<PreSignEntity?> { 
  @override
...
final preSignCreateProvider = AsyncNotifierProvider<PreSignCreateController, PreSignEntity?>(PreSignCreateController.new);
