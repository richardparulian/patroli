...
class PreSignUpdateController extends AsyncNotifier<PreSignResponseEntity?> { 
  @override
  Future<PreSignResponseEntity?> build() async => null;
...
final preSignUpdateProvider = AsyncNotifierProvider<PreSignUpdateController, PreSignResponseEntity?>(PreSignUpdateController.new);
