...
class _CheckOutScreenState extends ConsumerState<CheckOutScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _onCapture() async {
    ...
    await _animationController.forward();
      ...
      final reportData = GoRouterState.of(context).extra as ReportsEntity;
      ...
      await notifier.runCheckOut(
        image: image,
        filename: filename,
        branchId: reportData.branch?.id ?? 0,
        ...
        success: (_) {
          ...
          AppDialog.showSuccess(
            ...
            onButtonPressed: () {
              ...
              ref.read(reportPagingControllerProvider).refresh();
        ...
        body: Stack(
          children: [
            Positioned.fill(
              ...
              child: _buildSelfieSection(reportData),
            ),
