...
class _CheckOutScreenState extends ConsumerState<CheckOutScreen> with SingleTickerProviderStateMixin {
  ...
  late final ProviderSubscription<ResultState<void>> _checkOutListener;
  ...
  void initState() {
    ...
    _checkOutListener = ref.listenManual<ResultState<void>>(checkOutNotifierProvider, (prev, next) {
