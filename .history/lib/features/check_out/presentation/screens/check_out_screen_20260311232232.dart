...
class _CheckOutScreenState extends ConsumerState<CheckOutScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(checkOutProvider, (prev, next) {
      ...
      if (!next.isLoading && !_cameraController!.value.isTakingPicture) {
      ...
      if (next.errorMessage != null && mounted) {  // Handle error
        AppDialog.showError(
          context: context,
          title: 'Gagal',
          ...
          buttonText: 'Oke',
          onButtonPressed: () {
            ref.read(checkOutProvider.notifier).consumeError();
        },
      );
      }
    });
