...
class _CheckOutScreenState extends ConsumerState<CheckOutScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _initCamera() async {
    ...
    try {
      ...
      ref.read(cameraProvider.notifier).setReady(true);
    } catch (e) {
      ref.read(cameraProvider.notifier).setReady(false);
  ...
  Widget build(BuildContext context) {
    ...
    final isCameraReady = ref.watch(cameraProvider.select((s) => s.isReady));
  ...
  Widget _buildSelfieSection( branchData) {
    final isCameraReady = ref.watch(cameraProvider.select((s) => s.isReady));
