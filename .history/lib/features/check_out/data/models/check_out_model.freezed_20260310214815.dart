...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,branchId,createdBy,selfieCheckIn,selfieCheckOut,checkOutAt,date,status,lightsStatus,bannerStatus,rollingDoorStatus,conditionRight,conditionLeft,conditionBack,conditionArround,notes,createdAt,updatedAt);

@override
String toString() {
  return 'CheckOutModel(id: $id, branchId: $branchId, createdBy: $createdBy, selfieCheckIn: $selfieCheckIn, selfieCheckOut: $selfieCheckOut, checkOutAt: $checkOutAt, date: $date, status: $status, lightsStatus: $lightsStatus, bannerStatus: $bannerStatus, rollingDoorStatus: $rollingDoorStatus, conditionRight: $conditionRight, conditionLeft: $conditionLeft, conditionBack: $conditionBack, conditionArround: $conditionArround, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int? id, int? branchId, int? createdBy, String? selfieCheckIn, String? selfieCheckOut, String? checkOutAt, String? date, int? status, String? lightsStatus, String? bannerStatus, String? rollingDoorStatus, String? conditionRight, String? conditionLeft, String? conditionBack, String? conditionArround, String? notes, String? createdAt, String? updatedAt
});
...
class _CheckOutModel extends CheckOutModel {
  const _CheckOutModel({this.id, this.branchId, this.createdBy, this.selfieCheckIn, this.selfieCheckOut, this.checkOutAt, this.date, this.status, this.lightsStatus, this.bannerStatus, this.rollingDoorStatus, this.conditionRight, this.conditionLeft, this.conditionBack, this.conditionArround, this.notes, this.createdAt, this.updatedAt}): super._();
