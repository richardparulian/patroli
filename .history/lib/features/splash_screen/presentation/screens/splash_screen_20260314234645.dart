...
import 'package:pos/features/auth/presentation/providers/auth_bootstrap_provider.dart';
...
class _SplashScreenState extends ConsumerState<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _navigateToNextScreen() async {
    ...
    if (!mounted) return;
    final isAuthenticated = await ref.read(authBootstrapProvider.future);
                      ...
                      child: Transform.scale(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Image.asset(color.brightness == Brightness.dark ? Assets.images.logos.pgiHorizontalWhite.path : Assets.images.logos.pgiHorizontal.path, width: 120, height: 40, fit: BoxFit.contain),
                          ],
                        ),
                      ),
                    ),
