          ...
          children: [
            ...
            if (!isCompleted) ...[
              AppIconButton(
                ...
                onPressed: () {
                  debugPrint('report.isEmptyReport: ${report.isEmptyReport}');
                  if (report.isEmptyReport) {
                    context.push(AppConstants.visitRoute, extra: CheckInRouteArgs(
                      report: report,
                      scanQr: null,
                      checkIn: null,
                    ));
  ...
  Widget _photoItem({required BuildContext context, required String title, required String url}) {
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () => context.push(AppConstants.imagePreviewRoute, extra: url),
          child: ClipRRect(
