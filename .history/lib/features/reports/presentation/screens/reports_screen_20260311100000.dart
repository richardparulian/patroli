...
class _ReportsScreenState extends ConsumerState<ReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final reportController = ref.watch(reportsStateProvider);
    final pagingController = ref.watch(reportPagingControllerProvider);
                  ...
                  itemBuilder: (context, report, index) {
                    ...
                    return Column(
                      children: [
                        ReportCard(
                          report: report,
                          onTap: () => context.push(AppConstants.reportDetailRoute, extra: report),
                        ),
