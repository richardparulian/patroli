...
import 'package:pos/features/reports/domain/extensions/extensions.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.reportData.branch?.name ?? 'Detail Laporan'),
          ...
          children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(widget.reportData.branch?.name ?? '---',
                            style: theme.textTheme.titleMedium?.copyWith(
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                          Text(widget.reportData.date?.toFullDate() ?? '---',
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: _timeItem(
                            icon: Iconsax.login,
                            title: 'Masuk',
                            value: widget.reportData.checkIn?.toTimeWithZone(),
                            theme: theme,
                          ),
                        ),
                        Expanded(
                      ...
                      children: [
                        Expanded(
                          child: _timeItem(
                            ...
                            title: 'Status Lampu',
                            value: widget.reportData.lightsStatus?.trim() ?? '---',
                            theme: theme,
                          ),
                        ),
                        Expanded(
                          child: _timeItem(
                            icon: Iconsax.image,
                            title: 'Status Banner',
                            value: widget.reportData.bannerStatus?.trim() ?? '---',
                            theme: theme,
                          ),
                        ),
                      ],
                      ...
                      children: [
                        Expanded(
                          child: _timeItem(
                            ...
                            title: 'Kondisi Kanan',
                            value: widget.reportData.conditionRight?.trim() ?? '---',
                            theme: theme,
                          ),
                        ),
                        Expanded(
                          child: _timeItem(
                            ...
                            title: 'Kondisi Kiri',
                            value: widget.reportData.conditionLeft?.trim() ?? '---',
                            theme: theme,
                          ),
                        ),
                      ],
                      ...
                      children: [
                        Expanded(
                          child: _timeItem(
                            ...
                            value: widget.reportData.conditionBack?.trim() ?? '---',
                            theme: theme,
                          ),
                        ),
                        Expanded(
                          child: _timeItem(
                            ...
                            value: widget.reportData.conditionAround?.trim() ?? '---',
                            theme: theme,
                          ),
                        ),
                      ],
                    ...
                    Text(widget.reportData.notes?.trim() ?? '---',
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    if (widget.reportData.checkInPhoto?.trim().isNotEmpty ?? false) ...[
                      _photoItem(
                        context: context,
                        title: 'Foto Masuk',
                        url: widget.reportData.checkInPhoto?.trim() ?? '',
                      ),
                    ],
                    if (widget.reportData.checkOutPhoto?.trim().isNotEmpty ?? false) ...[
                      const SizedBox(height: 16),
                      _photoItem(
                        context: context,
                        title: 'Foto Keluar',
                        url: widget.reportData.checkOutPhoto?.trim() ?? '',
                      ),
                    ],
                  ],
                ),
            ...
            if (!isCompleted) ...[
              AppIconButton(
                ...
                onPressed: () {
                  if (widget.reportData.isEmptyReport) {
                    context.push(AppConstants.visitRoute, extra: VisitRouteArgs(report: widget.reportData));
                  }

                  if (!widget.reportData.isEmptyReport) {
                    context.push(AppConstants.checkOutRoute, extra: {
                      'reportId': widget.reportData.id ?? 0,
                      'branchId': widget.reportData.branch?.id ?? 0,
                      'branchName': widget.reportData.branch?.name ?? '-',
                    });
                  }
                },
              ),
