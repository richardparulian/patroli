      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (report.checkInPhoto != null &&
                report.checkInPhoto!.isNotEmpty)
              _photoItem(
                context: context,
                title: "Foto Masuk",
                url: report.checkInPhoto!,
              ),

            if (report.checkOutPhoto != null &&
                report.checkOutPhoto!.isNotEmpty) ...[
              const SizedBox(height: 16),
              _photoItem(
                context: context,
                title: "Foto Keluar",
                url: report.checkOutPhoto!,
              ),
            ],
