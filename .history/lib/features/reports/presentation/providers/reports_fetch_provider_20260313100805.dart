...
import 'package:flutter_riverpod/flutter_riverpod.dart';
  ...
  class ReportsFetchNotifier extends Notifier<ReportsState> {
    ...
    void onSuccessReports(List<ReportsEntity> newReports, {bool isLoadMore = false}) {
      ...
      final hasReachedMax = newReports.length < 5; 
  ...
  final reportsFetchProvider = NotifierProvider<ReportsFetchNotifier, ReportsState>(ReportsFetchNotifier.new);