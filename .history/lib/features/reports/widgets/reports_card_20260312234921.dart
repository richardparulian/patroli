...
class _ReportCardState extends ConsumerState<ReportCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentIndex = ref.watch(reportsFetchProvider.select((state) => state.carouselIndexes[widget.report.id ?? 0] ?? 0));
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Text(widget.report.id?.toString() ?? '---')
                          ...
                          child: CarouselSlider(  
                            options: CarouselOptions(
                              ...
                              onPageChanged: (carouselIndex, reason) {
                                ref.read(reportsFetchProvider.notifier).setCarouselIndex(widget.report.id ?? 0, carouselIndex);
                              },
                            ),
