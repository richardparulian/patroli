...
class _ReportCardState extends ConsumerState<ReportCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentIndex = ref.watch(reportsStateProvider.select((state) => state.carouselIndexes[widget.report.id ?? 0] ?? 0));
                          ...
                          child: CarouselSlider(  
                            options: CarouselOptions(
                              ...
                              onPageChanged: (carouselIndex, reason) {
                                ref.read(reportsStateProvider.notifier).setCarouselIndex(widget.report.id ?? 0, carouselIndex);
                              },
                            ),
