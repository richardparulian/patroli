...
class ReportCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final String checkInPhoto = report.checkInPhoto ?? '';
    final String checkOutPhoto = report.checkOutPhoto ?? '';

    final List<String> imageUrls = [
      if (checkInPhoto.isNotEmpty) checkInPhoto,
      if (checkOutPhoto.isNotEmpty) checkOutPhoto,
    ];
