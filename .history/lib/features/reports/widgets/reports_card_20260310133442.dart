...
class ReportCard extends ConsumerStatefulWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final currentIndex = ref.watch(reportsStateProvider).carouselIndexes[report.id ?? 0] ?? 0;
                          ...
                          child: CarouselSlider(  
                            options: CarouselOptions(
                              ...
                              onPageChanged: (carouselIndex, reason) {
                                ref.read(reportsStateProvider.notifier).setCarouselIndex(report.id ?? 0, carouselIndex);
                              },
                            ),
