              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        report.createdBy.name.firstNameSecondName,
                        style: theme.textTheme.bodySmall?.copyWith(
                          color: color.onSurfaceVariant,
                        ),
                        maxLines: 1,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 4),
          Text(isCompleted ? 'Selesai' : 'Tertunda', style: theme.textTheme.labelSmall?.copyWith(color: color, fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
