                                  ...
                                  return ClipRRect(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        width: size.width > 600 ? size.width * 0.1 : size.width * 0.2,
                                        height: size.width > 600 ? size.width * 0.1 : size.width * 0.2,
                                        placeholder: (context, _) => Image.asset('assets/images/placeholder/placeholder.webp', fit: BoxFit.cover),
                                        errorWidget: (context, _, __) => Image.asset('assets/images/placeholder/error_image.webp', fit: BoxFit.cover),
                                      ),
                                    ),
                                  );
                                },
