              ...
              Row(
                children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  Icon(Iconsax.login, size: 16, color: color.onSurfaceVariant),
                  ...
                  Column(
                    children: [
                      SizedBox(
                        width: size.width > 600 ? size.width * 0.1 : size.width * 0.1,
                        height: size.width > 600 ? size.width * 0.1 : size.width * 0.1,
