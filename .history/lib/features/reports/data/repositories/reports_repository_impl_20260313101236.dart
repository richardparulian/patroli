...
class ReportsRepositoryImpl implements ReportsRepository {
  ...
  @override
  Future<Either<Failure, List<ReportsEntity>>> getReports({int? page, int? perPage, int? withPagination}) async {
    try {
      final result = await _remoteDataSource.fetchReports(page: page, perPage: perPage, withPagination: withPagination);
