...
abstract class ReportsRemoteDataSource {
  // :: Fetch all reportss
  Future<List<ReportsModel>> fetchReports({required int page, required int limit, required int pagination});
}
...
class ReportsRemoteDataSourceImpl implements ReportsRemoteDataSource {
  ...
  @override
  Future<List<ReportsModel>> fetchReports({required int page, required int limit, required int pagination}) async {
    try {
