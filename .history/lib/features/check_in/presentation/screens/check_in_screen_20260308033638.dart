...
class _CheckInScreenState extends ConsumerState<CheckInScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _initCamera() async {
    try {
      ...
      _cameraController = CameraController(frontCamera, ResolutionPreset.medium, enableAudio: false, imageFormatGroup: ImageFormatGroup.jpeg);
  ...
  Future<void> _onCapture() async {
    ...
    notifier.setStep(CheckInLoadingStep.takingPhoto);
    ...
    final filename = '${uuid}_${now.toLocal().millisecondsSinceEpoch}.jpg';
  ...
  Widget build(BuildContext context) {
    ...
    final loadingMessage = ref.watch(checkInStateProvider.select((s) => s.loadingMessage));
