...
class _CheckInScreenState extends ConsumerState<CheckInScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _onCapture() async {
    ...
    final uniqueFilename = '${userSession?.name ?? 'user'}_${ntpTime.millisecondsSinceEpoch}.jpg';
    await preSignController.createPreSign(request: PreSignRequest(filename: 'selfie.jpg'));
  }
