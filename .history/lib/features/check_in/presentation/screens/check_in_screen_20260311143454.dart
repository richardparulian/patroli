...
class _CheckInScreenState extends ConsumerState<CheckInScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(checkInStateProvider, (prev, next) {
      debugPrint('STATE CHANGE: ${next.checkInData}');
    });
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: AppIconButton(
              onPressed: () {
                debugPrint('checkInState.checkInData: ${checkInState.checkInData}');
              },
              // onPressed: () => context.push(AppConstants.visitRoute, 
