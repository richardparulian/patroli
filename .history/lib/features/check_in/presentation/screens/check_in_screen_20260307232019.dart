  ...
  Future<void> _onCapture() async {
    ...
    try {
      ...
      if (preSignState.hasError) {
        _showError('Gagal mendapatkan url upload: ${preSignState.error?.toString() ?? 'Terjadi kesalahan'}');
        return;
      }
      ...
      if (preSignEntity == null) {
        _showError('Gagal mempersiapkan upload gambar');
        return;
      }
    ...
    try {
      ...
      try {
        ...
        AppDialog.showError(
          context: context,
          title: 'Upload Gagal',
          message: 'Gagal mengupload foto selfie: ${e.toString()}',
        );
      ...
      try {
        ...
        AppDialog.showError(
          ...
          message: 'Gagal melakukan check-in: ${e.toString()}',
        );
