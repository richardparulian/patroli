...
class CheckInNotifier extends Notifier<ResultState<void>> {
  ...
  Future<void> runCheckIn({required XFile image, required String filename, required int branchId, required int reportId}) async {
    try {
...
final checkInStateProvider = NotifierProvider<CheckInNotifier, ResultState<void>>(CheckInNotifier.new);