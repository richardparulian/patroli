...
/// @nodoc
abstract mixin class $CheckInEntityCopyWith<$Res>  {
  factory $CheckInEntityCopyWith(CheckInEntity value, $Res Function(CheckInEntity) _then) = _$CheckInEntityCopyWithImpl;
@useResult
$Res call({
 int id, String? date, String? checkIn, String? checkOut, String? checkInPhoto, String? checkOutPhoto, String? lightsStatus, String? bannerStatus, String? rollingDoorStatus, String? conditionRight, String? conditionLeft, String? conditionBack, String? conditionAround, int? statusValue, String? statusDescription, String? notes
});
...
/// @nodoc
class _$CheckInEntityCopyWithImpl<$Res>
    implements $CheckInEntityCopyWith<$Res> {
  _$CheckInEntityCopyWithImpl(this._self, this._then);

  final CheckInEntity _self;
  final $Res Function(CheckInEntity) _then;
...
/// Adds pattern-matching-related methods to [CheckInEntity].
extension CheckInEntityPatterns on CheckInEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CheckInEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CheckInEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CheckInEntity value)  $default,){
final _that = this;
switch (_that) {
case _CheckInEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CheckInEntity value)?  $default,){
final _that = this;
switch (_that) {
case _CheckInEntity() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String? date,  String? checkIn,  String? checkOut,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  int? statusValue,  String? statusDescription,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckInEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String? date,  String? checkIn,  String? checkOut,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  int? statusValue,  String? statusDescription,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _CheckInEntity():
return $default(_that.id,_that.date,_that.checkIn,_that.checkOut,_that.checkInPhoto,_that.checkOutPhoto,_that.lightsStatus,_that.bannerStatus,_that.rollingDoorStatus,_that.conditionRight,_that.conditionLeft,_that.conditionBack,_that.conditionAround,_that.statusValue,_that.statusDescription,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String? date,  String? checkIn,  String? checkOut,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  int? statusValue,  String? statusDescription,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _CheckInEntity() when $default != null:
return $default(_that.id,_that.date,_that.checkIn,_that.checkOut,_that.checkInPhoto,_that.checkOutPhoto,_that.lightsStatus,_that.bannerStatus,_that.rollingDoorStatus,_that.conditionRight,_that.conditionLeft,_that.conditionBack,_that.conditionAround,_that.statusValue,_that.statusDescription,_that.notes);case _:
  return null;
...
class _CheckInEntity implements CheckInEntity {
  const _CheckInEntity({required this.id, this.date, this.checkIn, this.checkOut, this.checkInPhoto, this.checkOutPhoto, this.lightsStatus, this.bannerStatus, this.rollingDoorStatus, this.conditionRight, this.conditionLeft, this.conditionBack, this.conditionAround, this.statusValue, this.statusDescription, this.notes});
...
@pragma('vm:prefer-inline')
_$CheckInEntityCopyWith<_CheckInEntity> get copyWith => __$CheckInEntityCopyWithImpl<_CheckInEntity>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CheckInEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.date, date) || other.date == date)&&(identical(other.checkIn, checkIn) || other.checkIn == checkIn)&&(identical(other.checkOut, checkOut) || other.checkOut == checkOut)&&(identical(other.checkInPhoto, checkInPhoto) || other.checkInPhoto == checkInPhoto)&&(identical(other.checkOutPhoto, checkOutPhoto) || other.checkOutPhoto == checkOutPhoto)&&(identical(other.lightsStatus, lightsStatus) || other.lightsStatus == lightsStatus)&&(identical(other.bannerStatus, bannerStatus) || other.bannerStatus == bannerStatus)&&(identical(other.rollingDoorStatus, rollingDoorStatus) || other.rollingDoorStatus == rollingDoorStatus)&&(identical(other.conditionRight, conditionRight) || other.conditionRight == conditionRight)&&(identical(other.conditionLeft, conditionLeft) || other.conditionLeft == conditionLeft)&&(identical(other.conditionBack, conditionBack) || other.conditionBack == conditionBack)&&(identical(other.conditionAround, conditionAround) || other.conditionAround == conditionAround)&&(identical(other.statusValue, statusValue) || other.statusValue == statusValue)&&(identical(other.statusDescription, statusDescription) || other.statusDescription == statusDescription)&&(identical(other.notes, notes) || other.notes == notes));
}
...
/// @nodoc
abstract mixin class _$CheckInEntityCopyWith<$Res> implements $CheckInEntityCopyWith<$Res> {
  factory _$CheckInEntityCopyWith(_CheckInEntity value, $Res Function(_CheckInEntity) _then) = __$CheckInEntityCopyWithImpl;
@override @useResult
$Res call({
 int id, String? date, String? checkIn, String? checkOut, String? checkInPhoto, String? checkOutPhoto, String? lightsStatus, String? bannerStatus, String? rollingDoorStatus, String? conditionRight, String? conditionLeft, String? conditionBack, String? conditionAround, int? statusValue, String? statusDescription, String? notes
});
...
/// @nodoc
class __$CheckInEntityCopyWithImpl<$Res>
    implements _$CheckInEntityCopyWith<$Res> {
  __$CheckInEntityCopyWithImpl(this._self, this._then);

  final _CheckInEntity _self;
  final $Res Function(_CheckInEntity) _then;
