                    ...
                    Row(
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          ...
                          child: ClipOval(
                            child: CircleImages(
                              name: authAsync.value?.name ?? 'Security Patrol',
                            ),
                          ),
                        ),
                      ],
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Halo, ${authAsync.value?.name ?? '---'}',
                      style: theme.textTheme.titleMedium?.copyWith(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: AppButton(
                onPressed: _isLoggingOut || authAsync.isLoading ? null : () async {
                ...
                icon: _isLoggingOut || authAsync.isLoading ? const CircularProgressIndicator.adaptive(
