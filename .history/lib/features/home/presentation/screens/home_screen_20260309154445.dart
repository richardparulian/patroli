...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  return Shimmer.fromColors(
    baseColor: color.primaryContainer.withOpacity(0.3),
    highlightColor: color.primaryContainer.withOpacity(0.6),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Shimmer.fromColors(
                      // ← Gradient shimmer
                      baseColor: color.primaryContainer.withOpacity(0.4),
                      highlightColor: color.primaryContainer.withOpacity(0.7),
                      child: Container(
                        width: 120,
                        height: 16,
                        decoration: BoxDecoration(
