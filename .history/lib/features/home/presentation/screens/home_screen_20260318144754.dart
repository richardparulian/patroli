...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final appBarBackgroundColor = Color.lerp(Colors.transparent, color.primaryContainer, _scrollProgress);
    final appBarForegroundColor = Color.lerp(Colors.transparent, color.onPrimary, _scrollProgress) ?? color.onPrimary;
