    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(
            child: CustomPaint(
              painter: _RoundedTopRectPainter(
                color: color.surface,
                radius: 30,
              ),
              child: Container(
...
class _RoundedTopRectPainter extends CustomPainter {
  final Color color;
  final double radius;

  _RoundedTopRectPainter({required this.color, required this.radius});

  @override
  void paint(Canvas canvas, Size size) {
    final paint = Paint()..color = color;
    final rect = Rect.fromLTWH(0, -radius, size.width, size.height + radius);
  ...
  @override
  bool shouldRepaint(_RoundedTopRectPainter oldDelegate) {
