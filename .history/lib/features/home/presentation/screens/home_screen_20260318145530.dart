...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void _handleScroll() {
    final progress = (_scrollController.offset / 24).clamp(0.0, 1.0);
          ...
          child: CustomScrollView(
            ...
            slivers: [
              SliverAppBar(
                ...
                backgroundColor: appBarForegroundColor,
                title: Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: theme.textTheme.bodyMedium?.copyWith(
                                  color: color.onPrimary.withValues(
                                    alpha: 0.8 * headerSubtitleOpacity,
                                  ),
                                ),
                              ),
                            ],
                  ...
                  await AppDialog.showLogoutConfirm(
                    ...
                    onConfirm: () async {
                      final result = await ref
                          .read(authLogoutProvider.notifier)
                          .runLogout();
