...
class HomeScreen extends ConsumerWidget {
  ...
  Widget _menuCard({required String title, required String subtitle, required IconData icon, required VoidCallback onTap, required BuildContext context}) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              color: isDark ? Colors.black.withValues(alpha: 0.6) : Colors.black.withValues(alpha: 0.04),
            ),
          ],
        ),
        child: Row(
          children: [
            ...
            Icon(Iconsax.arrow_right_3, size: 16, color: isDark ? Colors.white70 : Colors.grey.shade600),
          ],
        ),
      ),
    );
