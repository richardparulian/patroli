...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget _summaryCard(BuildContext context, ReportsState reportsState) {
    ...
    return Container(
      ...
      child: const ShimmerDashboard(),
      // child: !reportsState.isLoading ? const ShimmerDashboard() : reportsState.isError ? _buildErrorRetry(context, reportsState) : _buildSummaryContent(context, reportsState),
    );
  }
