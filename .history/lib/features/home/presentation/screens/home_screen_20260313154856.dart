          ...
          slivers: [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Padding(
                  padding: const EdgeInsets.fromLTRB(20, kToolbarHeight + 25, 20, 20),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
            ...
            //   pinned: false,
            //   delegate: TopRadiusDelegate(color.surface),
            // ),
...
class TopRadiusDelegate extends SliverPersistentHeaderDelegate {
  final Color color;

  TopRadiusDelegate(this.color);
  ...
  @override
  bool shouldRebuild(covariant TopRadiusDelegate oldDelegate) {
    return false;
  }
}