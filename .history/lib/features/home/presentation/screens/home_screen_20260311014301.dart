...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(reportsStateProvider.notifier).countReports(pagination: 0);
    });
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: reportsState.isError ? color.error.withValues(alpha: 0.5) : color.primaryContainer,
                    ...
                    _buildMenuCard(
                      ...
                      onTap: () => context.go(AppConstants.historyReport),
                    ),
                  ],
                ),
              ),
