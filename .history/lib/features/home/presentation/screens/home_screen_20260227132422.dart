  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: AppButton(
          label: isLoading ? null : 'Keluar',
          fontSize: 16,
          onPressed: isLoading ? null : () async => await ref.read(authProvider.notifier).logout(),
          icon: isLoading ? const CircularProgressIndicator.adaptive(
