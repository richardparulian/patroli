...
class LocalBiometricService implements BiometricService {
  ...
  Future<BiometricResult> authenticate({
    ...
    try {
      ...
      debugPrint(
        'Biometric authentication error: ${e.description ?? e.message}, code: ${e.code}',
      );
  ...
  BiometricResult _mapExceptionCodeToResult(
    ...
    switch (code) {
      ...
      case local_auth.LocalAuthExceptionCode.biometricHardwareNotSupported:
      case local_auth.LocalAuthExceptionCode.notAvailable:
      case local_auth.LocalAuthExceptionCode.passcodeNotSet:
        return BiometricResult.notAvailable;
      ...
      case local_auth.LocalAuthExceptionCode.appCancel:
