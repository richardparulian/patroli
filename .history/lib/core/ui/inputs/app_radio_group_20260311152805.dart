...
class AppRadioGroup<T> extends ConsumerWidget {
  ...
  Widget _buildInfoCard({required BuildContext context, required IconData icon, required Color colors, required String title, required String? value, required String? notes}) {
    final theme = Theme.of(context);
