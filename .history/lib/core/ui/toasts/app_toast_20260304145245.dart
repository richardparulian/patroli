...
class AppToast {
  ...
  static void showError({required String title, String? description, ToastPosition position = ToastPosition.top, Duration? duration, VoidCallback? onDismiss, bool showProgressBar = false}) {
    toastification.show(
  ...
  static EdgeInsets _getMargin(ToastPosition position) {
    switch (position) {
      case ToastPosition.top:
        return const EdgeInsets.fromLTRB(15, kToolbarHeight, 15, 16);
      case ToastPosition.bottom:
