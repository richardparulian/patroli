...
class AppToast {
  ...
  static void showError({required String title, String? description, ToastPosition position = ToastPosition.top, Duration duration = const Duration(seconds: 4), VoidCallback? onDismiss, bool showProgressBar = false}) {
    ...
    toastification.show(
      ...
      primaryColor: theme.colorScheme.primary.withValues(alpha: 0.5),
