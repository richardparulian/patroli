...
class AppToast {
  ...
  static void showError({required BuildContext context, required String title, String? description, ToastPosition position = ToastPosition.top, Duration duration = const Duration(seconds: 4), VoidCallback? onDismiss, bool showProgressBar = false}) {
