...
class AppToast {
  ...
  static void showError({required BuildContext context, required String title, String? description, ToastPosition position = ToastPosition.top, Duration? duration, bool showProgressBar = false}) {
    ...
    toastification.show(
      ...
      icon: Container(
        ...
        child: Icon(Iconsax.info_circle5, color: colorScheme.onSurface, size: 28),
      ),
      ...
      closeButton: ToastCloseButton(
        buttonBuilder: (context, onClose) => Center(
          child: GestureDetector(
            onTap: () => onClose(),
            child: Icon(Iconsax.close_circle5, color: colorScheme.onSurface, size: 28),
          ),
        ),
      ),
    );
