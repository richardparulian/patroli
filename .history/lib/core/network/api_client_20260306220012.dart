...
class ApiClient {
  ...
  Failure _handleError(DioException e) {
    ...
    debugPrint('Dio error request options: ${e.requestOptions}');
    debugPrint('Dio error error: ${e.error}');
    debugPrint('Dio error stack trace: ${e.stackTrace}');
    switch (e.type) {
      case DioExceptionType.connectionTimeout:
      case DioExceptionType.sendTimeout:
      case DioExceptionType.receiveTimeout:
        return const ServerFailure(message: 'Waktu koneksi habis');
