...
class BasicUpdateService implements UpdateService {
  ...
  BasicUpdateService({required String androidPackageName, required String iOSAppId}) : _androidPackageName = androidPackageName, _iOSAppId = iOSAppId;
  ...
  Future<UpdateInfo> _fetchUpdateInfo() async {
    ...
    return UpdateInfo(
      ...
      updateUrl: Platform.isAndroid ? 'https://play.google.com/store/apps/details?id=$_androidPackageName' : 'https://apps.apple.com/app/id$_iOSAppId',
    );
  }
}
