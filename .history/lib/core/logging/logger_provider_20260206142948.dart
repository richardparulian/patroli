...
extension LoggerPerformanceExtension on Logger {
  ...
  T timeSync<T>(String operationName, T Function() operation, {Map<String, dynamic>? data}) {
  ...
  Future<T> timeAsync<T>(String operationName, Future<T> Function() operation, {Map<String, dynamic>? data}) async {
    final stopwatch = Stopwatch()..start();
    try {
...
mixin LoggerMixin {
  ...
  void logVerbose(String message, {Map<String, dynamic>? data, Object? error, StackTrace? stackTrace}) {
    logger.v(message, data: data, error: error, stackTrace: stackTrace);
  }

  void logDebug(String message, {Map<String, dynamic>? data, Object? error, StackTrace? stackTrace}) {
    logger.d(message, data: data, error: error, stackTrace: stackTrace);
  }

  void logInfo(String message, {Map<String, dynamic>? data, Object? error, StackTrace? stackTrace}) {
    logger.i(message, data: data, error: error, stackTrace: stackTrace);
  }

  void logWarning(String message, {Map<String, dynamic>? data, Object? error, StackTrace? stackTrace}) {
  ...
  void logCritical(String message, {Map<String, dynamic>? data, Object? error, StackTrace? stackTrace}) {
    logger.c(message, data: data, error: error, stackTrace: stackTrace);
  }

  void logPerformance(String message, {Map<String, dynamic>? data, Duration? duration}) {
