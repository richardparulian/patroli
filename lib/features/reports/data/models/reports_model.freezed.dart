...
mixin _$ReportsModel {
 ...
 int? get id; String? get date; String? get checkIn; String? get checkOut; CreatedModel? get createdBy; BranchModel? get branch; String? get checkInPhoto; String? get checkOutPhoto; String? get lightsStatus; String? get bannerStatus; String? get rollingDoorStatus; String? get conditionRight; String? get conditionLeft; String? get conditionBack; String? get conditionAround; int? get statusValue; String? get statusDescription; String? get notes;
...
@useResult
$Res call({
 int? id, String? date, String? checkIn, String? checkOut, CreatedModel? createdBy, BranchModel? branch, String? checkInPhoto, String? checkOutPhoto, String? lightsStatus, String? bannerStatus, String? rollingDoorStatus, String? conditionRight, String? conditionLeft, String? conditionBack, String? conditionAround, int? statusValue, String? statusDescription, String? notes
});


$CreatedModelCopyWith<$Res>? get createdBy;$BranchModelCopyWith<$Res>? get branch;
...
as CreatedModel?,branch: freezed == branch ? _self.branch : branch // ignore: cast_nullable_to_non_nullable
as BranchModel?,checkInPhoto: freezed == checkInPhoto ? _self.checkInPhoto : checkInPhoto // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$CreatedModelCopyWith<$Res>? get createdBy {
    if (_self.createdBy == null) {
    return null;
  }

  return $CreatedModelCopyWith<$Res>(_self.createdBy!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? date,  String? checkIn,  String? checkOut,  CreatedModel? createdBy,  BranchModel? branch,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  int? statusValue,  String? statusDescription,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReportsModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? date,  String? checkIn,  String? checkOut,  CreatedModel? createdBy,  BranchModel? branch,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  int? statusValue,  String? statusDescription,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _ReportsModel():
return $default(_that.id,_that.date,_that.checkIn,_that.checkOut,_that.createdBy,_that.branch,_that.checkInPhoto,_that.checkOutPhoto,_that.lightsStatus,_that.bannerStatus,_that.rollingDoorStatus,_that.conditionRight,_that.conditionLeft,_that.conditionBack,_that.conditionAround,_that.statusValue,_that.statusDescription,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? date,  String? checkIn,  String? checkOut,  CreatedModel? createdBy,  BranchModel? branch,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  int? statusValue,  String? statusDescription,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _ReportsModel() when $default != null:
return $default(_that.id,_that.date,_that.checkIn,_that.checkOut,_that.createdBy,_that.branch,_that.checkInPhoto,_that.checkOutPhoto,_that.lightsStatus,_that.bannerStatus,_that.rollingDoorStatus,_that.conditionRight,_that.conditionLeft,_that.conditionBack,_that.conditionAround,_that.statusValue,_that.statusDescription,_that.notes);case _:
  return null;
...
class _ReportsModel extends ReportsModel {
  const _ReportsModel({this.id, this.date, this.checkIn, this.checkOut, this.createdBy, this.branch, this.checkInPhoto, this.checkOutPhoto, this.lightsStatus, this.bannerStatus, this.rollingDoorStatus, this.conditionRight, this.conditionLeft, this.conditionBack, this.conditionAround, this.statusValue, this.statusDescription, this.notes}): super._();
...
@override final  CreatedModel? createdBy;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReportsModel&&(identical(other.id, id) || other.id == id)&&(identical(other.date, date) || other.date == date)&&(identical(other.checkIn, checkIn) || other.checkIn == checkIn)&&(identical(other.checkOut, checkOut) || other.checkOut == checkOut)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.branch, branch) || other.branch == branch)&&(identical(other.checkInPhoto, checkInPhoto) || other.checkInPhoto == checkInPhoto)&&(identical(other.checkOutPhoto, checkOutPhoto) || other.checkOutPhoto == checkOutPhoto)&&(identical(other.lightsStatus, lightsStatus) || other.lightsStatus == lightsStatus)&&(identical(other.bannerStatus, bannerStatus) || other.bannerStatus == bannerStatus)&&(identical(other.rollingDoorStatus, rollingDoorStatus) || other.rollingDoorStatus == rollingDoorStatus)&&(identical(other.conditionRight, conditionRight) || other.conditionRight == conditionRight)&&(identical(other.conditionLeft, conditionLeft) || other.conditionLeft == conditionLeft)&&(identical(other.conditionBack, conditionBack) || other.conditionBack == conditionBack)&&(identical(other.conditionAround, conditionAround) || other.conditionAround == conditionAround)&&(identical(other.statusValue, statusValue) || other.statusValue == statusValue)&&(identical(other.statusDescription, statusDescription) || other.statusDescription == statusDescription)&&(identical(other.notes, notes) || other.notes == notes));
}
...
@override $CreatedModelCopyWith<$Res>? get createdBy;@override $BranchModelCopyWith<$Res>? get branch;
