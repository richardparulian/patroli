...
mixin _$ScanQrModel {
 ...
 int? get id; String? get name; int? get kanitId; String? get kanitUsername; String? get kanitName; int? get kacabId; String? get kacabUsername; String? get kacabName; int? get areaManagerId; String? get areaManagerUsername; String? get areaManagerName; String? get qrcode; AttentionModel? get visitAttention;
...
@override
String toString() {
  return 'ScanQrModel(id: $id, name: $name, kanitId: $kanitId, kanitUsername: $kanitUsername, kanitName: $kanitName, kacabId: $kacabId, kacabUsername: $kacabUsername, kacabName: $kacabName, areaManagerId: $areaManagerId, areaManagerUsername: $areaManagerUsername, areaManagerName: $areaManagerName, qrcode: $qrcode, visitAttention: $visitAttention)';
}
...
@useResult
$Res call({
 int? id, String? name, int? kanitId, String? kanitUsername, String? kanitName, int? kacabId, String? kacabUsername, String? kacabName, int? areaManagerId, String? areaManagerUsername, String? areaManagerName, String? qrcode, AttentionModel? visitAttention
});


$AttentionModelCopyWith<$Res>? get visitAttention;
...
$AttentionModelCopyWith<$Res>? get visitAttention {
  ...
  return $AttentionModelCopyWith<$Res>(_self.visitAttention!, (value) {
...
class _ScanQrModel extends ScanQrModel {
  const _ScanQrModel({this.id, this.name, this.kanitId, this.kanitUsername, this.kanitName, this.kacabId, this.kacabUsername, this.kacabName, this.areaManagerId, this.areaManagerUsername, this.areaManagerName, this.qrcode, this.visitAttention}): super._();
...
@override final  AttentionModel? visitAttention;
...
@override $AttentionModelCopyWith<$Res>? get visitAttention;
