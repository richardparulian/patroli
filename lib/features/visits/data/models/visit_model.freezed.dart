...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,date,checkIn,checkOut,checkInPhoto,checkOutPhoto,lightsStatus,bannerStatus,rollingDoorStatus,conditionRight,conditionLeft,conditionBack,conditionAround,notes,statusValue,statusDescription);

@override
String toString() {
  return 'VisitModel(id: $id, date: $date, checkIn: $checkIn, checkOut: $checkOut, checkInPhoto: $checkInPhoto, checkOutPhoto: $checkOutPhoto, lightsStatus: $lightsStatus, bannerStatus: $bannerStatus, rollingDoorStatus: $rollingDoorStatus, conditionRight: $conditionRight, conditionLeft: $conditionLeft, conditionBack: $conditionBack, conditionAround: $conditionAround, notes: $notes, statusValue: $statusValue, statusDescription: $statusDescription)';
}
...
@useResult
$Res call({
 int? id, String? date, String? checkIn, String? checkOut, String? checkInPhoto, String? checkOutPhoto, String? lightsStatus, String? bannerStatus, String? rollingDoorStatus, String? conditionRight, String? conditionLeft, String? conditionBack, String? conditionAround, String? notes, int? statusValue, String? statusDescription
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? date,  String? checkIn,  String? checkOut,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  String? notes,  int? statusValue,  String? statusDescription)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VisitModel() when $default != null:
return $default(_that.id,_that.date,_that.checkIn,_that.checkOut,_that.checkInPhoto,_that.checkOutPhoto,_that.lightsStatus,_that.bannerStatus,_that.rollingDoorStatus,_that.conditionRight,_that.conditionLeft,_that.conditionBack,_that.conditionAround,_that.notes,_that.statusValue,_that.statusDescription);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? date,  String? checkIn,  String? checkOut,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  String? notes,  int? statusValue,  String? statusDescription)  $default,) {final _that = this;
switch (_that) {
case _VisitModel():
return $default(_that.id,_that.date,_that.checkIn,_that.checkOut,_that.checkInPhoto,_that.checkOutPhoto,_that.lightsStatus,_that.bannerStatus,_that.rollingDoorStatus,_that.conditionRight,_that.conditionLeft,_that.conditionBack,_that.conditionAround,_that.notes,_that.statusValue,_that.statusDescription);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? date,  String? checkIn,  String? checkOut,  String? checkInPhoto,  String? checkOutPhoto,  String? lightsStatus,  String? bannerStatus,  String? rollingDoorStatus,  String? conditionRight,  String? conditionLeft,  String? conditionBack,  String? conditionAround,  String? notes,  int? statusValue,  String? statusDescription)?  $default,) {final _that = this;
switch (_that) {
case _VisitModel() when $default != null:
return $default(_that.id,_that.date,_that.checkIn,_that.checkOut,_that.checkInPhoto,_that.checkOutPhoto,_that.lightsStatus,_that.bannerStatus,_that.rollingDoorStatus,_that.conditionRight,_that.conditionLeft,_that.conditionBack,_that.conditionAround,_that.notes,_that.statusValue,_that.statusDescription);case _:
  return null;
...
class _VisitModel extends VisitModel {
  const _VisitModel({this.id, this.date, this.checkIn, this.checkOut, this.checkInPhoto, this.checkOutPhoto, this.lightsStatus, this.bannerStatus, this.rollingDoorStatus, this.conditionRight, this.conditionLeft, this.conditionBack, this.conditionAround, this.notes, this.statusValue, this.statusDescription}): super._();
