...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isPasswordVisible = ref.watch(
      loginFlowProvider.select((s) => s.isPasswordVisible),
    );
    final isLoading = ref.watch(
      loginFlowProvider.select((s) => s.isSubmitting),
    );
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      height:
                          ScreenUtil.sh(10) + MediaQuery.paddingOf(context).top,
                    ),
                    Image.asset(
                      'assets/images/logos/pgi-horizontal.webp',
                        ...
                        children: [
                          AppTextField(
                            ...
                            validator: (val) =>
                                ...
                                ? context.tr('employee_number_required')
                                : null,
                          ),
                          SizedBox(height: ScreenUtil.sh(15)),
                          AppTextField(
